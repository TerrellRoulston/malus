...
occ_cor <- gbif_cor %>% 
  filter(countryCode %in% c('US', 'CA')) %>% # limit to CA and US (their native range)
...
I like to create a seperate file for WorldClim data, it makes workflow easier and more reproducible. Create a folder within the head of the project.
```{r}
setwd("../wclim_data/")
