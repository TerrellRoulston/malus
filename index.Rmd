...
**Note:** It may also be helpful to save individual raster layers for the low, moderate and high suitability results. This of course can quickly become a lot of layers/files but it can help in situations where you may want to share these results with others as it is clear what the results are rather than having to send them complete predictions and threshold files. And of course we can re-load them for downstream work as done many times above.
...
Now that we have made all our predictions and saved all results as `.Rdata` files lets move onto to tidying up plots to prepare them for a results section and publication! Also, if you have made it this far take a minute to appreciate just how much work has been accomplished.
