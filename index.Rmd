...
**IMPORTANT NOTE:** This workflow and code differs slightly from the code published to the "https://github.com/TerrellRoulston/malus" repository, and is an example rather than a standard on how to perform species distribibution. One major naunced differeceF
...
```{r, eval = TRUE, echo=FALSE, out.width= '1000px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/statistical analysis/boyce index/cor_pred_hist_cbi.jpeg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '1500px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/maps/raw_figures/coronaria_habitat_suitability.jpg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '1500px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/maps/raw_figures/gap_scores/cor_in_situ_bar.jpeg"))
```
